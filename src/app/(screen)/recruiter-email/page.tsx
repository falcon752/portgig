...
function VerificationCodeContent() {
  ...
  const handleVerifyOTPCode = useCallback(async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setTimeout(() => {
          router.push('/recruiter-email-confirmed')
        }, 5000)
      }
    } catch (error) {
  ...
  return (
    <main className='min-h-screen flex flex-col items-center bg-gray-50 p-4 sm:p-8 md:p-10 font-sans md:bg-gray-50 max-md:bg-[url("/assets/auth-woman-2.png")] max-md:bg-cover max-md:bg-no-repeat max-md:bg-center relative'>
        ...
        <div className='self-start mb-6'>
          <Link href='/'>
            <Image
              ...
              width={120}
              height={120}
              className='block md:hidden max-md:w-[80px] max-md:h-[80px] cursor-pointer'
            />
          </Link>
        </div>
        <div className='self-start mb-6'>
          <Link href='/'>
            <Image
              ...
              width={120}
              height={120}
              className='hidden md:block max-md:w-[80px] max-md:h-[80px] cursor-pointer'
            />
          </Link>
        </div>
