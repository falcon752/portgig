    ...
    <main className="text-black my-10">
      ...
      <div className="bodyMargin px-2 md:px-10 py-10 flex flex-col gap-10">
        <div className="flex flex-col gap-3 md:gap-5">
          <h2 className="text-base md:text-3xl font-raleway font-extrabold text-[#0A1754]">
            For Creatives, By Creatives
          </h2>
          <p className="font-raleway font-medium text-[20px] leading-[39px] tracking-[0%] text-[#0A1754]">
            {forCreativeText}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 lg:gap-5">
          ...
          <ol className="list-decimal pl-4 space-y-2 text-xs md:text-sm lg:text-2xl font-raleway font-medium text-[#0A1754]">
            {spaceWhere.map((text, index) => (
              <li key={index}>
                <p className="font-raleway font-medium text-[20px] leading-[56px] tracking-[0%] text-[#0A1754]">
                  {text}
                </p>
              </li>
            ))}
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="h-[124px] w-[363px] bg-primary text-white flex flex-col items-center justify-center rounded-2xl font-raleway text-center px-2">
                <p className="text-xs md:text-sm lg:text-2xl font-bold">
                  {member.name}
                </p>
