    ...
    >
      ...
      {(isSignin || isRecruiterSignin) && (
        <div className="flex items-center gap-5 w-full mt-4">
          <hr className="border-t border-t-white grow" />
