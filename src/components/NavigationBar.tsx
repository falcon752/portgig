  ...
  return (
    <nav className="sticky w-full top-0 z-50 h-14 text-primary bg-white">
      <div className="w-full flex justify-center h-full">
        <div className="max-w-[1250px] w-full flex items-center justify-between px-4">
          {/* DESKTOP LAYOUT */}
          ...
          {/* Desktop Nav Links */}
          <div className="max-lg:hidden w-[600px] font-bold text-primary text-[16px] font-urbanist">
