    ...
    <div className="border-y border-[#F9C221] mt-14">
      <div className="bg-[#0F172A] text-[#E2E8F0] px-4 py-12 md:px-10">
        <div className="max-w-6xl mx-auto">
          {/* Title */}
          <h2 className="text-2xl md:text-3xl font-bold mb-6" style={getHeadingStyle()}>Food Brand</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center w-full md:w-1/2">
              <h3 className="font-bold text-lg mb-3" style={getHeadingStyle()}>Before</h3>
              <div className="border-2 border-white bg-[#1E293B] aspect-square w-full max-w-xs mx-auto rounded-lg shadow-md" />
            </div>

            <div className="text-center w-full md:w-1/2">
              <h3 className="font-bold text-lg mb-3" style={getHeadingStyle()}>After</h3>
              <div className="border-2 border-white bg-[#1E293B] aspect-square w-full max-w-xs mx-auto rounded-lg shadow-md" />
            </div>
          </div>
        </div>
