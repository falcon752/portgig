...
export default function ExploreCreatives() {
  ...
  const handleStartChat = async (creative: Creator) => {
    ...
    try {
      ...
      console.log("Starting chat between:", {
        currentUser: currentUser.bio_data?.full_name || "Unknown",
        creative: creative.bio_data.full_name,
        currentUserType,
        creativeUserType,
      });
      ...
      >
        ...
        <div className={cn("flex justify-between px-2 mt-5")}>
          <button
            ...
            className={cn(
              "py-2 px-5 w-fit rounded-lg text-sm font-medium bg-primary text-white",
          ...
          <button
            ...
            className={cn(
              "py-2 px-5 w-fit rounded-lg text-sm font-medium bg-primary text-white",
              "cursor-pointer hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            )}
          >
  ...
  const renderCreatorsGrid = () => (
    <div
      className={cn(
        "bodyMargin grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"
      )}
    >
            ...
            return (
              ...
              >
                <div className={cn("flex justify-between items-center")}>
                  ...
                  >
                    {mapExperienceToSkillLevel(
                      String(creator.profile.years_of_experience)
                    )}
                  </div>
                </div>
                <h2 className={cn("font-bold text-sm px-5")}>
