    ...
    >
      ...
      >
        <div className="flex flex-col gap-0 sm:gap-1 md:gap-2 lg:gap-3">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-urbanist ml-6 sm:ml-10 md:ml-16 lg:ml-20">
            Create.{" "}
            <span className="text-sm sm:text-lg md:text-2xl lg:text-3xl font-urbanist block ml-23 sm:inline -mt-4 sm:ml-0">
              Thrive.
            </span>
          </h1>
        </div>
        ...
        <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 lg:gap-5 font-raleway max-w-xs sm:max-w-sm md:max-w-md">
          <p className="hidden sm:block text-[10px] md:text-xs lg:text-sm font-medium leading-relaxed">
            Get a stunning portfolio that speaks for you. Showcase your skills,
            impress recruiters, and land your next big opportunity.
          </p>

          <p className="text-[9px] sm:text-[10px] md:text-xs lg:text-sm font-normal">
