...
const RecruiterCommunity = () => {
  return (
    <section className="my-0 lg:my-10 flex flex-col gap-5 bodyMargin">
      ...
      <div className="flex flex-row gap-4 lg:gap-10 bg-white lg:bg-primary my-0 lg:my-5 p-4 sm:p-8 rounded-2xl text-white font-raleway">
        <div className="flex flex-col gap-2 lg:gap-10 w-full lg:w-2/3">
          ...
          <div className="flex flex-col gap-3 sm:gap-5">
            <h2 className="text-xs md:text-3xl font-bold max-lg:-[#0A1754] max-lg:text-[#0A1754]">
              Join the Community
            </h2>
            <Buttons
              label="Click here"
