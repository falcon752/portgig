...
interface CorperateTemplateProps {
  formData: FormData
}

export const CorperateTemplate: React.FC<CorperateTemplateProps> = ({ formData }) => {
  return (
    <div className="corperate-template">
      <style jsx>{`
      ...
      <div className="section">
        ...
        <div className="experience-item">
          <div className="form-row">
            <div className="form-field">{formData.experience?.[0]?.job_title || "Brand"}</div>
          </div>
          <div className="form-row">
            <div className="form-field">{formData.experience?.[0]?.location || "Location"}</div>
          </div>
          <div className="form-row">
            <div className="form-field">
              {formData.experience?.[0]?.ended
                ? `What year- ended ${formData.experience[0].ended}`
                : "What year- ended when"}
            </div>
          </div>
          <div className="form-row">
            <div className="form-field large">
              {formData.experience?.[0]?.contribution || "How did you help/what did you do"}
            </div>
          </div>
        </div>
      </div>
...
export const generateCorperateTemplateHTML = (formData: FormData): string => {
  return `
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <div class="experience-item">
          <div class="form-row">
            <div class="form-field">
              ${formData.experience?.[0]?.job_title || "Brand"}
            </div>
          </div>
          <div class="form-row">
            <div class="form-field">
              ${formData.experience?.[0]?.location || "Location"}
            </div>
          </div>
          <div class="form-row">
            <div class="form-field">
