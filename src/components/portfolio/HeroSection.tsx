...
const HeroSection = () => {
  return (
    <div className="bg-[#F2F2F2] text-[#0F172A] font-urbanist">
      ...
      {/* Bottom Buttons */}
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row flex-wrap justify-center md:justify-evenly lg:justify-between items-center mt-10 bg-[#0A1F63] rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 text-white font-semibold text-base md:text-lg lg:text-xl font-raleway gap-4 md:gap-6 lg:gap-8 shadow-2xl text-center md:mx-6 lg:mx-auto">
