...
const HeroSection = () => {
  return (
    <div className="bg-[#F2F2F2] text-[#0F172A] font-urbanist">
      ...
      {/* Highlight Banner */}
      <div className="w-full max-w-[1280px] bg-[#00489A] text-white text-base md:text-lg lg:text-xl px-5 py-5 sm:p-6 md:py-7 md:px-10 lg:px-14 my-10 shadow-xl text-center font-raleway opacity-100 mx-auto">
      ...
      {/* Info Text */}
      <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 lg:px-0 text-[20px] text-[#0A1754] space-y-5 font-raleway font-semibold leading-[39px]">
        <p>
      ...
      {/* Bottom Buttons */}
      <div className="w-full max-w-[1280px] mx-auto flex flex-col sm:flex-row flex-wrap justify-center md:justify-evenly lg:justify-between items-center mt-10 bg-[#0A1F63] rounded-none lg:rounded-4xl p-4 sm:p-6 md:p-8 lg:p-10 text-white font-semibold text-base md:text-lg lg:text-xl font-raleway gap-4 md:gap-6 lg:gap-8 shadow-2xl text-center">
        <button className="font-black">
          Select the template for your niche
        </button>
